            ...
            <v-row dense>
                ...
                <v-col v-for="(data,i) in rank_menu" :key="i" :cols="6">
                    <v-card elevation="3" height="auto" width="auto">
                        ...
                        <v-card-title v-text="data.food[0].name"> </v-card-title>
                        <v-row no-gutters>
                            <v-col cols=8>
                                <v-img class="ml-5" :src="data.food[0].image_name" height="auto" width="auto">
                                </v-img>
                            </v-col>
                        </v-row>
                        ...
                        <v-card-actions class="d-flex justify-end">
                            <v-row dense>
                                <v-icon dense class="ml-5">mdi-currency-usd</v-icon>{{data.food[0].price}} Bath
                            </v-row>
                            ...
                            <div class="text-center">
                                <v-dialog v-model="menuinfo" width="1000" :retain-focus="false">
                                    <template v-slot:activator="{ on, attrs }">
                                        <v-btn icon v-bind="attrs" v-on="on" class="" @click="getcurrent(data.food[0])">
        ...
        <v-container fluid v-else>
            <v-row dense>
                ...
                <v-col v-for="(data,i) in searchmenu" :key="i" :cols="6">                
                    <v-card elevation="3" height="auto" width="auto" @click="test">
                        <!-- <v-card elevation="3" max-height="500" max-width="500"> -->
